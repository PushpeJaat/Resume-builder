    ...
    <>
      ...
      <div className="mt-6 flex flex-col sm:flex-row gap-4">
        <Link
          ...
          className="flex-1 inline-flex items-center justify-center px-6 py-4 rounded-lg bg-gradient-to-r from-sky-600 to-cyan-600 text-white font-semibold shadow-lg shadow-sky-600/30 hover:brightness-105 transition-all duration-300"
        >
