...
export function EditorLayout({ editor, preview, previewFooter, className }: EditorLayoutProps) {
  ...
  return (
    <div className={cn("min-h-0 flex-1", className)}>
      <div className="hidden h-full min-h-0 flex-1 gap-4 xl:grid xl:grid-cols-[minmax(0,1fr)_minmax(430px,46%)]">
        ...
        <aside className="min-h-0">
          <section className="group/preview-panel flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-emerald-200/85 bg-[linear-gradient(150deg,rgba(236,253,245,0.55)_0%,rgba(255,255,255,0.96)_45%,rgba(240,253,250,0.75)_100%)] shadow-[0_22px_70px_-54px_rgba(5,150,105,0.42)] xl:sticky xl:top-1">
      ...
      <div className="flex h-full min-h-0 xl:hidden">
        {mobileView === "editor" ? (
